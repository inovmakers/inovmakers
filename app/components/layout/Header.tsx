    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-[72px] max-w-6xl items-center justify-between px-5 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <a href="#contato" className="hidden min-h-10 items-center rounded-full bg-blue-700 px-4 text-sm font-semibold text-white transition hover:bg-blue-800 sm:inline-flex">Leve para sua escola</a>
