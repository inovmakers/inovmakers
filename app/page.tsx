...
export default function Home() {
  return (
    <>
      ...
      <section id="contato" className="bg-slate-950 py-24 text-white"><div className="mx-auto max-w-7xl px-6"><div className="mx-auto max-w-3xl text-center"><span className="inline-flex rounded-full border border-blue-400/30 bg-blue-500/10 px-4 py-2 text-sm font-semibold uppercase tracking-wider text-blue-400">Entre em contato</span><h2 className="mt-5 text-4xl font-bold tracking-tight lg:text-5xl">Vamos transformar a educa\u00e7\u00e3o juntos?</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">Fale com a InovMakers para conhecer nossos projetos, forma\u00e7\u00f5es e solu\u00e7\u00f5es em educa\u00e7\u00e3o, tecnologia e inova\u00e7\u00e3o.</p></div><div className="mx-auto mt-12 grid max-w-4xl gap-6 md:grid-cols-2"><a href="mailto:inovmaker@gmail.com" className="group rounded-3xl border border-slate-800 bg-slate-900 p-8 transition duration-300 hover:-translate-y-1 hover:border-blue-500 hover:bg-slate-800 hover:shadow-2xl"><div className="flex items-start gap-5"><div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-600 text-2xl font-bold shadow-lg">@</div><div><p className="text-sm font-semibold uppercase tracking-wider text-blue-400">E-mail</p><h3 className="mt-2 break-all text-xl font-bold text-white">inovmaker@gmail.com</h3><p className="mt-2 text-sm leading-6 text-slate-400">Clique para enviar uma mensagem diretamente para a InovMakers.</p></div></div><span className="mt-6 inline-flex rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-900 transition group-hover:bg-blue-500 group-hover:text-white">Enviar e-mail</span></a><a href="https://www.instagram.com/inovmakers" target="_blank" rel="noopener noreferrer" className="group rounded-3xl border border-slate-800 bg-slate-900 p-8 transition duration-300 hover:-translate-y-1 hover:border-pink-500 hover:bg-slate-800 hover:shadow-2xl"><div className="flex items-start gap-5"><div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-xl font-bold shadow-lg">IG</div><div><p className="text-sm font-semibold uppercase tracking-wider text-pink-400">Instagram</p><h3 className="mt-2 text-xl font-bold text-white">@inovmakers</h3><p className="mt-2 text-sm leading-6 text-slate-400">Acompanhe projetos, novidades e iniciativas da InovMakers.</p></div></div><span className="mt-6 inline-flex rounded-full border border-slate-600 px-5 py-2.5 text-sm font-semibold text-white transition group-hover:border-pink-400 group-hover:text-pink-400">Visitar Instagram</span></a></div><div className="mx-auto mt-10 max-w-4xl rounded-3xl border border-blue-500/20 bg-blue-500/10 p-6 text-center"><p className="text-sm font-medium text-blue-200">InovMakers | Educa\u00e7\u00e3o, Tecnologia e Inova\u00e7\u00e3o</p><p className="mt-2 text-sm text-slate-400">Conectando pessoas, conhecimento, criatividade e tecnologia para transformar a aprendizagem.</p></div></div></section>
</>
  );
}
