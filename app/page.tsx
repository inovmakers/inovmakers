...
export default function Home() {
  return (
    <>
      ...
      <section id="contato" className="bg-slate-950 py-24 text-white"><div style={{width:"100%",maxWidth:"1000px",marginLeft:"auto",marginRight:"auto",paddingLeft:"24px",paddingRight:"24px"}}><div style={{width:"100%",maxWidth:"760px",marginLeft:"auto",marginRight:"auto",textAlign:"center"}}><span className="inline-flex rounded-full bg-blue-500/10 px-4 py-1.5 text-sm font-semibold uppercase tracking-wider text-blue-400">Entre em contato</span><h2 className="mt-5 text-4xl font-bold leading-tight tracking-tight lg:text-5xl">Vamos transformar a educação juntos?</h2><p className="mt-5 text-base leading-7 text-slate-300 lg:text-lg">Fale com a InovMakers para conhecer nossos projetos, formações e soluções em educação, tecnologia e inovação.</p></div><div style={{display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:"24px",width:"100%",maxWidth:"900px",marginLeft:"auto",marginRight:"auto",marginTop:"48px"}}><a href="mailto:inovmaker@gmail.com" className="group rounded-3xl border border-slate-700 bg-slate-900 p-7 text-left shadow-lg transition hover:-translate-y-1 hover:border-blue-500"><div className="flex items-start gap-5"><span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-600 text-2xl font-bold">@</span><span><span className="block text-xs font-bold uppercase tracking-widest text-blue-400">E-mail</span><span className="mt-1 block text-xl font-bold text-white">inovmaker@gmail.com</span><span className="mt-2 block text-sm leading-6 text-slate-400">Clique para enviar uma mensagem diretamente para a InovMakers.</span><span className="mt-3 block text-sm font-semibold text-blue-300">Enviar e-mail →</span></span></div></a><a href="https://www.instagram.com/inovmakers" target="_blank" rel="noopener noreferrer" className="group rounded-3xl border border-slate-700 bg-slate-900 p-7 text-left shadow-lg transition hover:-translate-y-1 hover:border-pink-500"><div className="flex items-start gap-5"><span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white"><svg viewBox="0 0 24 24" className="h-8 w-8" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4.2"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></span><span><span className="block text-xs font-bold uppercase tracking-widest text-pink-400">Instagram</span><span className="mt-1 block text-xl font-bold text-white">@inovmakers</span><span className="mt-2 block text-sm leading-6 text-slate-400">Acompanhe projetos, novidades e iniciativas da InovMakers.</span><span className="mt-3 block text-sm font-semibold text-pink-300">Visitar Instagram →</span></span></div></a></div><div style={{width:"100%",maxWidth:"900px",marginLeft:"auto",marginRight:"auto",marginTop:"32px",textAlign:"center"}} className="rounded-3xl border border-blue-500/20 bg-blue-500/10 px-6 py-5"><p className="text-sm font-semibold text-blue-200">InovMakers | Educação, Tecnologia e Inovação</p><p className="mt-2 text-sm leading-6 text-slate-400">Conectando pessoas, conhecimento, criatividade e tecnologia para transformar a aprendizagem.</p></div></div></section>
</>
  );
}
