...
export default function Home() {
  return (
    <>
      ...
      <section id="contato" className="bg-slate-950 py-16 text-white" style={{width:"100%",display:"flex",justifyContent:"center",boxSizing:"border-box"}}><div className="w-full" style={{maxWidth:"900px",margin:"0 auto",padding:"0 20px",boxSizing:"border-box"}}><div style={{maxWidth:"650px",margin:"0 auto",textAlign:"center"}}><span className="inline-flex rounded-full bg-blue-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-blue-400">Entre em contato</span><h2 className="mt-3 text-3xl font-bold leading-tight tracking-tight lg:text-4xl">Vamos transformar a educação juntos?</h2><p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-300 lg:text-base">Fale com a InovMakers para conhecer nossos projetos, formações e soluções em educação, tecnologia e inovação.</p></div><div className="mt-8" style={{maxWidth:"760px",marginLeft:"auto",marginRight:"auto",display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:"16px"}}><a href="mailto:inovmaker@gmail.com" className="rounded-2xl border border-slate-700 bg-slate-900 p-5 text-left shadow-md transition hover:-translate-y-1 hover:border-blue-500"><div className="flex items-center gap-4"><span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-blue-600 text-xl font-bold text-white">@</span><span className="min-w-0"><span className="block text-[10px] font-bold uppercase tracking-widest text-blue-400">E-mail</span><span className="mt-1 block break-all text-base font-bold text-white">inovmaker@gmail.com</span><span className="mt-1 block text-xs leading-5 text-slate-400">Clique para enviar uma mensagem.</span></span></div></a><a href="https://www.instagram.com/inovmakers" target="_blank" rel="noopener noreferrer" className="rounded-2xl border border-slate-700 bg-slate-900 p-5 text-left shadow-md transition hover:-translate-y-1 hover:border-pink-500"><div className="flex items-center gap-4"><span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 text-white"><svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4.2"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></span><span><span className="block text-[10px] font-bold uppercase tracking-widest text-pink-400">Instagram</span><span className="mt-1 block text-base font-bold text-white">@inovmakers</span><span className="mt-1 block text-xs leading-5 text-slate-400">Acompanhe nossos projetos e novidades.</span></span></div></a></div><div className="mt-6 rounded-2xl border border-blue-500/20 bg-blue-500/10 px-5 py-4 text-center" style={{maxWidth:"760px",marginLeft:"auto",marginRight:"auto"}}><p className="text-xs font-semibold text-blue-200">InovMakers | Educação, Tecnologia e Inovação</p><p className="mt-1 text-xs text-slate-400">Conectando conhecimento, criatividade e tecnologia para transformar a aprendizagem.</p></div></div></section>
</>
  );
}
