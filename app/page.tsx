...
export default function Home() {
  return (
    <>
      ...
      <section id="contato" className="w-full bg-slate-950 py-20 text-white"><div className="mx-auto w-full max-w-6xl px-6"><div className="mx-auto w-full max-w-3xl text-center"><span className="inline-flex rounded-full bg-blue-500/10 px-4 py-2 text-sm font-semibold uppercase tracking-wider text-blue-400">Entre em contato</span><h2 className="mt-5 text-4xl font-bold leading-tight lg:text-5xl">Vamos transformar a educação juntos?</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">Fale com a InovMakers para conhecer nossos projetos, formações e soluções em educação, tecnologia e inovação.</p></div><div className="mx-auto mt-10 grid w-full max-w-5xl grid-cols-1 gap-6 md:grid-cols-2"><a href="mailto:inovmaker@gmail.com" className="w-full rounded-3xl border border-slate-700 bg-slate-900/80 p-7 transition hover:-translate-y-1 hover:border-blue-500"><div className="flex items-start gap-5"><div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-600 text-2xl font-bold text-white">@</div><div><p className="text-xs font-bold uppercase tracking-widest text-blue-400">E-mail</p><p className="mt-1 text-xl font-bold text-white">inovmaker@gmail.com</p><p className="mt-2 text-sm leading-6 text-slate-400">Clique para enviar uma mensagem diretamente para a InovMakers.</p></div></div><span className="mt-6 inline-flex rounded-full bg-white px-5 py-2 text-sm font-semibold text-slate-900">Enviar e-mail</span></a><a href="https://www.instagram.com/inovmakers" target="_blank" rel="noopener noreferrer" className="w-full rounded-3xl border border-slate-700 bg-slate-900/80 p-7 transition hover:-translate-y-1 hover:border-pink-500"><div className="flex items-start gap-5"><div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 text-white"><rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="4" stroke="currentColor" strokeWidth="2"/><circle cx="17.5" cy="6.5" r="1.2" fill="currentColor"/></svg></div><div><p className="text-xs font-bold uppercase tracking-widest text-pink-400">Instagram</p><p className="mt-1 text-xl font-bold text-white">@inovmakers</p><p className="mt-2 text-sm leading-6 text-slate-400">Acompanhe projetos, novidades e iniciativas da InovMakers.</p></div></div><span className="mt-6 inline-flex rounded-full border border-slate-600 px-5 py-2 text-sm font-semibold text-white">Visitar Instagram</span></a></div><div className="mx-auto mt-10 w-full max-w-4xl rounded-3xl border border-blue-500/20 bg-blue-500/10 p-6 text-center"><p className="text-sm font-medium text-blue-200">InovMakers | Educação, Tecnologia e Inovação</p><p className="mt-2 text-sm text-slate-400">Conectando pessoas, conhecimento, criatividade e tecnologia para transformar a aprendizagem.</p></div></div></section>
</>
  );
}
